...
public struct NetworkManager {    
    ...
    public func get<T: Decodable>(with urlString: String) async throws -> T {
    ...
    public func post(with urlString: String, with parameter: Parameters) async throws -> URLResponse {
    ...
    public func put(with urlString: String, with parameter: Parameters) async throws -> URLResponse {
        let url = URL(string: baseURL + urlString)
        guard let url = url else { throw ServerError.notFound }
    ...
    public func patch(with urlString: String, with parameter: Parameters) async throws -> URLResponse {
        let url = URL(string: baseURL + urlString)
        guard let url = url else { throw ServerError.notFound }
    ...
    public func refreshTokenAndRetryUpdate(with method: HTTPMethod, with url: URL, with parameter: Parameters) async throws -> URLResponse {
    ...
    public func delete(to urlString: String, with parameter: Parameters) async throws {
        let url = URL(string: baseURL + urlString)
        guard let url = url else { throw ServerError.notFound }
